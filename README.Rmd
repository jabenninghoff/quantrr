...
[example reports](https://jabenninghoff.github.io/quantrr/example/) that can be copied or modified for
...
1. Run `source("preview.R")` to build and display the example analysis reports.
