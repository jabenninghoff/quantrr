...
development workflow (for advanced users). Rendered versions of the standalone example reports are
...
1. Download and install the latest version of
   [R for macOS](https://cran.r-project.org/bin/macosx/). Choose the appropriate version for your
...
The [standalone version](../example/) contains an example analysis for the "Widget Management
