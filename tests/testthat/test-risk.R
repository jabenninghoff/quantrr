...
test_that("calc_risk returns correct values", {
  test_calc <- withr::with_seed(
    429406278,
    calc_risk("Loss of Customer", 2.0, 14.162084, 1.610574, treatment = "base", runs = 10)
  )
  expected_years <- 1:10
  expected_risks <- rep("Loss of Customer", 10)
  expected_treatment <- rep("base", 10)
  ...
  expect_identical(test_calc$treatment, expected_treatment)
