...
Forecast risk using Monte Carlo simulation. The average events, losses, and 'typical' losses
(geometric mean) for each risk are summarized below:
...
forecast |>
  group_by(risk) |>
  summarize(avg_events = mean(events), avg_losses = mean(losses), typ_losses = gmean(losses)) |>
